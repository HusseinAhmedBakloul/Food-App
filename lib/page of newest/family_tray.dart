...
class FamilyTray extends StatefulWidget {
  const FamilyTray({Key? key}) : super(key: key);

  @override
  _FamilyTrayState createState() => _FamilyTrayState();
}

class _FamilyTrayState extends State<FamilyTray> {
  int _value = 1;
  final double _basePrice = 350.0;
        ...
        actions: [
          Consumer<MywishPageModel>(
            builder: (context, wishPageModel, child) {
              final isFavorite = wishPageModel.items.any((item) => item['name'] == 'Family Tray' && item['description'] == 'A generous serving of succulent, slow-cooked meat, perfect for sharing with the whole family. This tray includes a variety of cuts, expertly seasoned and roasted to perfection.');
              return IconButton(
                icon: Icon(
                ...
                onPressed: () {
                  setState(() {
                    if (isFavorite) {
                      wishPageModel.removeItem(wishPageModel.items.indexWhere((item) => item['name'] == 'Family Tray' && item['description'] == 'A generous serving of succulent, slow-cooked meat, perfect for sharing with the whole family. This tray includes a variety of cuts, expertly seasoned and roasted to perfection.'));
                    } else {
                      wishPageModel.addItem(
                        'Family Tray',
                        'A generous serving of succulent, slow-cooked meat, perfect for sharing with the whole family. This tray includes a variety of cuts, expertly seasoned and roasted to perfection.',
                        _basePrice,
                        'images/Screenshot_2024-02-25_223300-removebg-preview.png',
                      );
                    }
                  });
                },
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 30,
            bottom: 555,
            child: Image.asset('images/Screenshot_2024-02-25_223300-removebg-preview.png'),
          ),
        ],
      ),
    );
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 23),
              _buildIngredientImage('images/Screenshot 2024-07-16 130217.png'),
            ],
          ),
        ),
      ],
