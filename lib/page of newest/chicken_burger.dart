...
class ChickenBurger extends StatefulWidget {
  ...
  @override
  _ChickenBurgerState createState() => _ChickenBurgerState();
}

class _ChickenBurgerState extends State<ChickenBurger> {
  int _value = 1;
  final double _basePrice = 110.0;
        ...
        actions: [
          Consumer<MywishPageModel>(
            builder: (context, wishPageModel, child) {
              final isFavorite = wishPageModel.items.any((item) => item['name'] == 'Fried Chicken Burger' && item['description'] == 'Succulent chicken breast smothered in a rich and creamy Alfredo sauce, infused with garlic and parmesan.');
              return IconButton(
                icon: Icon(
                ...
                onPressed: () {
                  if (isFavorite) {
                    wishPageModel.removeItem(wishPageModel.items.indexWhere((item) => item['name'] == 'Fried Chicken Burger' && item['description'] == 'Succulent chicken breast smothered in a rich and creamy Alfredo sauce, infused with garlic and parmesan.'));
                  } else {
                    wishPageModel.addItem('Fried Chicken Burger', 'Succulent chicken breast smothered in a rich and creamy Alfredo sauce, infused with garlic and parmesan.', _basePrice, 'images/istockphoto-1776252085-612x612_-_Copy-removebg-preview.png');
                  }
                },
              );
            },
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 60,
            bottom: 565,
            child: Image.asset('images/istockphoto-1776252085-612x612_-_Copy-removebg-preview.png'),
          ),
        ],
      ),
    );
  ...
  Widget _buildAddToCartButton(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        cartModel.addItem(
          'Fried Chicken Burger',
          'Succulent chicken breast smothered in a rich and creamy Alfredo sauce, infused with garlic and parmesan.',
          _basePrice,
          'images/istockphoto-1776252085-612x612_-_Copy-removebg-preview.png',
          _value,
        );
