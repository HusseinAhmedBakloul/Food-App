...
class SteakPotatoesPage extends StatefulWidget {
  const SteakPotatoesPage({Key? key}) : super(key: key);

  @override
  _SteakPotatoesPageState createState() => _SteakPotatoesPageState();
}

class _SteakPotatoesPageState extends State<SteakPotatoesPage> {
  int _value = 1;
          ...
          Consumer<MywishPageModel>(
            builder: (context, wishPageModel, child) {
              final isFavorite = wishPageModel.items.any(
                (item) => item['name'] == 'Steak & Potatoes' &&
                          item['description'] == 'A classic, hearty meal featuring a perfectly grilled steak seasoned with a blend of herbs and spices, golden-brown roasted potatoes, making it the perfect choice for a delicious meal.',
              );
              return IconButton(
                icon: Icon(
                  ...
                  setState(() {
                    if (isFavorite) {
                      ...
                      wishPageModel.addItem(
                        'Steak & Potatoes',
                        'A classic, hearty meal featuring a perfectly grilled steak seasoned with a blend of herbs and spices, golden-brown roasted potatoes, making it the perfect choice for a delicious meal.',
                        _basePrice,
                        'images/istockphoto-146058150-612x612-removebg-preview.png',
                      );
                    }
                  });
                },
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 50,
            bottom: 570,
            child: Image.asset('images/istockphoto-146058150-612x612-removebg-preview.png'),
          ),
        ],
      ),
    );
    ...
    return Column(
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              _buildIngredientImage('images/Screenshot 2024-07-16 114052.png'),
  ...
  Widget _buildAddToCartButton(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        cartModel.addItem(
          'Steak & Potatoes',
          'A classic, hearty meal featuring a perfectly grilled steak seasoned with a blend of herbs and spices, accompanied by crispy, golden-brown roasted potatoes, making it the perfect choice for a delicious meal.',
          _basePrice,
          'images/istockphoto-146058150-612x612-removebg-preview.png',
          _value,
        );
